...
class CommentDescription extends StatefulWidget {
  final String comment;
  final String parent;
  final String childKey;

  const CommentDescription({Key key,this.comment, this.parent, this.childKey}) : super(key: key);

  @override
  _CommentDescriptionState createState() => _CommentDescriptionState();
}

class _CommentDescriptionState extends State<CommentDescription> {
                    ...
                    SizedBox(
                      ...
                      child: Wrap(
                        children: [
                          Padding(
                            padding: const EdgeInsets.only(left: 8.0,right:8.0),
                            child: Text("${_controller.text.trim().isNotEmpty? taskState.taskList[num.parse(widget.parent)]["sub-children"][num.parse(widget.childKey)]["description"] : "No comment yet" }",
                              style: TextStyle(
                      ...
                      child: MouseRegion(
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.symmetric(horizontal: 14,vertical: 6),                              child: Icon(Icons.close,
